...
namespace Les23
{
    public partial class Form1 : Form
    {
        ...
        private void Experience4_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
                ...
                comboBox1.Text != string.Empty && comboBox2.Text != string.Empty && comboBox3.Text != string.Empty)
            {
                ...
                {
                    File.AppendAllText("Работники.txt", "\r\n" + LastName + " " + FirstName + " " + Patronymic + "\r\n");
                    if (Man.Checked) File.AppendAllText("Работники.txt", "Пол - Мужской\r\n");
                    if (Woman.Checked) File.AppendAllText("Работники.txt", "Пол - Женский\r\n");
                    File.AppendAllText("Работники.txt", "Дата рождения - " + Data + "\r\n");
                    File.AppendAllText("Работники.txt", "Домашний адрес - " + HomeAdress + "\r\n");
                    File.AppendAllText("Работники.txt", "Email адрес - " + EmailAdress + "\r\n");
                    File.AppendAllText("Работники.txt", "Мобильный телефон - " + PhoneType + " " + PhoneNumber + "\r\n");
                    string lineOne = "Стаж работы - ";
                    switch (experience)
                    {
                        case 1: File.AppendAllText("Работники.txt", "Прежде не работал" + "\r\n"); break;
                        case 2: File.AppendAllText("Работники.txt", lineOne + "Меньше 1 года" + "\r\n"); break;
                        case 3: File.AppendAllText("Работники.txt", lineOne + "От 1 года до 5 лет" + "\r\n"); break;
                        case 4: File.AppendAllText("Работники.txt", lineOne + "От 5 до 9 лет" + "\r\n"); break;
                        case 5: File.AppendAllText("Работники.txt", lineOne + "10 лет и больше" + "\r\n"); break;
                    }
                    string lineTwo = "Тип занятости - ";
                    switch (schedule)
                    {
                        case 1: File.AppendAllText("Работники.txt", lineTwo + "Полная занятость" + "\r\n"); break;
                        case 2: File.AppendAllText("Работники.txt", lineTwo + "Частичная занятость" + "\r\n"); break;
                        case 3: File.AppendAllText("Работники.txt", lineTwo + "Работа на дому" + "\r\n"); break;
                        case 4: File.AppendAllText("Работники.txt", lineTwo + "Посменная работа" + "\r\n"); break;
                    }

                    if (checkBox1.Checked) File.AppendAllText("Работники.txt", "Личный автомобиль - Есть\r\n");
                    else File.AppendAllText("Работники.txt", "Личного автомобиля - Нету\r\n");

                    if (checkBox2.Checked)
                    {
                        File.AppendAllText("Работники.txt", "Водительское удостоверение - Есть ");
                        if (checkBox3.Checked) File.AppendAllText("Работники.txt", " A");
                        if (checkBox4.Checked) File.AppendAllText("Работники.txt", " B");
                        if (checkBox5.Checked) File.AppendAllText("Работники.txt", " C");
                        if (checkBox6.Checked) File.AppendAllText("Работники.txt", " D");
                        File.AppendAllText("Работники.txt", "\r\n");

                    }
                    else File.AppendAllText("Работники.txt", "Водительское удостоверение - Нету\r\n");
                    if (MinSalary != "0" && MaxSalary != "0") File.AppendAllText("Работники.txt", "ЗП от:" + MinSalary + " до:" + MaxSalary + "\r\n");
                    if (richTextBox1.Text != String.Empty) File.AppendAllText("Работники.txt", "Краткое резюме:\r\n" + Summary + "\r\n");
                    File.AppendAllText("Работники.txt", "=================================\r\n");
